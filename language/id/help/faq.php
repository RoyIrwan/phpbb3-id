...
$lang = array_merge($lang, array(
	'HELP_FAQ_ATTACHMENTS_ALLOWED_ANSWER'	=> 'Setiap administrator situs, dapat membolehkan atau tidak jenis lampiran tertentu. Jika kurang yakin apa saja yang boleh diunggah, hubungi administrator situs untuk pencerahan.',
	...
	'HELP_FAQ_ATTACHMENTS_ALLOWED_QUESTION'	=> 'Jenis lampiran apa saja yang diperbolehkan di situs ini?', //'What attachments are allowed on this board?',
	...
	'HELP_FAQ_BOOKMARKS_TOPIC_ANSWER'	=> 'Untuk menandai atau berlangganan topik tertentu, klik tautan menu “Perkakas topik”, terletak di atas dan bawah diskusi pada topik yang bersangkutan.<br />Membalas pesan pada suatu topik dengan opsi “Beritahu saya ketika ada posting balasan” tercentang (aktif) juga akan menjadi berlangganan pada topik tersebut.',
	...
	'HELP_FAQ_BOOKMARKS_TOPIC_QUESTION'	=> 'Bagaimana cara menandai atau berlangganan pada topik tertentu?',
										// 'How do I bookmark or subscribe to specific topics?',

	'HELP_FAQ_FORMATTING_ANNOUNCEMENT_ANSWER'	=> 'Pengumuman sering kali berisi berbagai informasi penting dan dianjurkan untuk membaca semua pengumuman. Pengumuman ditampilkam di atas tiap halaman dalam forum dimana pengumuman itu ditujukan. Seperti pengumuman global, hak akses pengumuman diberikan oleh administrator situs.',
												// 'Announcements often contain important information for the forum you are currently reading and you should read them whenever possible. Announcements appear at the top of every page in the forum to which they are posted. As with global announcements, announcement permissions are granted by the board administrator.',
	'HELP_FAQ_FORMATTING_ANNOUNCEMENT_QUESTION'	=> 'Apa itu pengumuman?', //'What are announcements?',
	'HELP_FAQ_FORMATTING_BBOCDE_ANSWER'	=> 'BBCode skrip khusus seperti HTML, untuk mengontrol format obyek tertentu dalam suatu posting. Ijin penggunaan BBCode diberikan oleh administrator, tapi juga dapat dinonaktifkan untuk posting tertentu melalui form isian posting. BBCode sendiri mirip HTML, tapi tiap tag ditutup dengan kurung siku [ dan ], bukan &lt; dan &gt; seperti pada HTML. Untuk informasi lebih lanjut tentang BBCode, baca pada panduan yang dapat diakses dari halaman posting.',
										// 'BBCode is a special implementation of HTML, offering great formatting control on particular objects in a post. The use of BBCode is granted by the administrator, but it can also be disabled on a per post basis from the posting form. BBCode itself is similar in style to HTML, but tags are enclosed in square brackets [ and ] rather than &lt; and &gt;. For more information on BBCode see the guide which can be accessed from the posting page.',
	'HELP_FAQ_FORMATTING_BBOCDE_QUESTION'	=> 'Apa itu BBCode?', //'What is BBCode?',
	'HELP_FAQ_FORMATTING_GLOBAL_ANNOUNCE_ANSWER'	=> 'Pengumuman global berisi tentang berbagai informasi penting, dan dianjurkan untuk membaca semua pengumuman. Pengumuman akan ditampilkan di atas tiap forum dan dalam Kontrol Panel Pengguna. Hak akses pengumuman global diberikan oleh administrator situs.',
	...
	'HELP_FAQ_FORMATTING_GLOBAL_ANNOUNCE_QUESTION'	=> 'Apa itu pengumuman global?', //'What are global announcements?',
	'HELP_FAQ_FORMATTING_HTML_ANSWER'	=> 'Tidak bisa. Di situs ini tidak bisa memposting HTML dan ditampilkan sebagai HTML. Hampir semua format pada HTML, dapat dilakukan menggunakan BBCode.',
	...
	'HELP_FAQ_FORMATTING_HTML_QUESTION'	=> 'Apakah postingan bisa menggunakan HTML?', //'Can I use HTML?', 
	'HELP_FAQ_FORMATTING_ICONS_ANSWER'	=> 'Ikon topik adalah gambar-gambar pilihan penulis yang berkaitan dengan isi posting. Kemampuan untuk menggunakan ikon topik tergantung dari hak yang ditentukan oleh administrator situs.',
	...
	'HELP_FAQ_FORMATTING_ICONS_QUESTION'	=> 'Apa itu ikon topik?', //'What are topic icons?',
	'HELP_FAQ_FORMATTING_IMAGES_ANSWER'	=> 'Bisa, gambar bisa ditampilkan di postingan. Jika administrator mengijinkan untuk penggunaan lampiran, gambar bisa diunggah ke situs. Sebaliknya, gambar hanya bisa dipost menggunakan tautan ke gambar yang tersimpan di web dan yang bisa diakses oleh publik, contohnya, http://www.zontoh.com/gambarku.gif. Tautan gambar tidak bisa untuk gambar yang tersimpan pada PC lokal (kecuali jika bisa diakses secara publik di internet) dan tautan gambar juga tidak bisa untuk gambar yang tersimpan di internet yang membutuhkan otentikasi untuk mengaksesnya, contohnya, dalam kotak surat (mailbox) hotmail atau yahoo, situs dengan proteksi kata sandi, dan lain-lain. To display the image use the BBCode [img] tag.',
										// 'Yes, images can be shown in your posts. If the administrator has allowed attachments, you may be able to upload the image to the board. Otherwise, you must link to an image stored on a publicly accessible web server, e.g. http://www.example.com/my-picture.gif. You cannot link to pictures stored on your own PC (unless it is a publicly accessible server) nor images stored behind authentication mechanisms, e.g. hotmail or yahoo mailboxes, password protected sites, etc. To display the image use the BBCode [img] tag.',
	'HELP_FAQ_FORMATTING_IMAGES_QUESTION'	=> 'Apakah gambar bisa dipost?', //'Can I post images?',
