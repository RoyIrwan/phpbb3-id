...
$lang = array_merge($lang, array(
	'HELP_FAQ_ATTACHMENTS_ALLOWED_ANSWER'	=> 'Setiap administrator forum, dapat membolehkan atau tidak jenis lampiran tertentu. Jika kurang yakin apa saja yang boleh diunggah, hubungi administrator untuk pencerahan.',
	...
	'HELP_FAQ_ATTACHMENTS_ALLOWED_QUESTION'	=> 'Jenis lampiran apa saja yang diperbolehkan di forum ini?', //'What attachments are allowed on this board?',
	'HELP_FAQ_ATTACHMENTS_OWN_ANSWER'	=> 'Untuk melihat daftar lampiran apa saja yang telah kita unggah, buka Panel Kontro Pengguna dan klik tautan ke bagian lampiran.',
	...
	'HELP_FAQ_ATTACHMENTS_OWN_QUESTION'	=> 'Bagaimana cara menemukan semua lampiran kita?', //'How do I find all my attachments?',

	'HELP_FAQ_BLOCK_ATTACHMENTS'	=> 'Lampiran',
	'HELP_FAQ_BLOCK_BOOKMARKS'	=> 'Langganan dan Penanda',
	'HELP_FAQ_BLOCK_FORMATTING'	=> 'Format dan Jenis Topik',
	'HELP_FAQ_BLOCK_FRIENDS'	=> 'Teman dan Lawan',
	'HELP_FAQ_BLOCK_GROUPS'	=> 'Level Pengguna dan Kelompok',
	'HELP_FAQ_BLOCK_ISSUES'	=> 'Permasalahan phpBB',
	'HELP_FAQ_BLOCK_LOGIN'	=> 'Permasalahan Login dan Registrasi',
	'HELP_FAQ_BLOCK_PMS'	=> 'Pesan Pribadi',
	'HELP_FAQ_BLOCK_POSTING'	=> 'Permasalahan Posting',
	'HELP_FAQ_BLOCK_SEARCH'	=> 'Mencari di Forum',
	'HELP_FAQ_BLOCK_USERSETTINGS'	=> 'Preferensi dan Pengaturan Pengguna', //'User Preferences and settings',

	'HELP_FAQ_BOOKMARKS_DIFFERENCE_ANSWER'	=> 'Pada phpBB 3.0, cara kerja menandai topik mirip dengan menandai pada peramban (browser) internet. Kita tidak notifikasi apabila ada perbaruan. Sementara pada phpBB 3.1, menandai topik mirip seperti kita berlangganan topik tersebut. Akan ada notifikasi apabila topik tersebut diperbarui atau ada perubahan. Tapi, berlangganan topik tertentu, tidak akan mendapat notifikasi apabila ada perubahan pada topik atau forum tersebut. Opsi notifikasi untuk Penanda dan Berlangganan dapat dikonfigurasi pada Panel Kontrol Pengguna, di bawah “Preferensi Forum”.',
	...
	'HELP_FAQ_BOOKMARKS_DIFFERENCE_QUESTION'	=> 'Apa perbedaan antara menandai dan berlangganan?', 
												// 'What is the difference between bookmarking and subscribing?',
	'HELP_FAQ_BOOKMARKS_FORUM_ANSWER'	=> 'Untuk berlangganan forum tertentu, klik tautan "Berlangganan forum", di bagian bawah halaman, pada saat memasuki forum.',
										// 'To subscribe to a specific forum, click the “Subscribe forum” link, at the bottom of page, upon entering the forum.',
	'HELP_FAQ_BOOKMARKS_FORUM_QUESTION'	=> 'Bagaimana cara berlangganan forum tertentu?', //'How do I subscribe to specific forums?',
	'HELP_FAQ_BOOKMARKS_REMOVE_ANSWER'	=> 'Untuk berhenti berlangganan, buka Panel Kontro Pengguna dan ikuti tautan ke langganan.',
										// 'To remove your subscriptions, go to your User Control Panel and follow the links to your subscriptions.',
	'HELP_FAQ_BOOKMARKS_REMOVE_QUESTION'	=> 'Bagaimana cara berhenti berlangganan?', // 'How do I remove my subscriptions?',
